    ...
    <div class="container mt-4 border shadow rounded">
        ...
        <div class="header d-flex justify-content-center align-items-center p-4 bg-light border-bottom">
            <h1 class="dashboard-heading">
                <i class="fas fa-chart-pie"></i>STATUTORY COMPLIANCE
            </h1>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card bg-light border-1 shadow-lg h-100">
                        <div class="card-body text-center d-flex flex-column justify-content-center">
                            ...
                            <h5 class="card-title fw-bold">Academics</h5>
                        </div>
                        <div class="card-footer bg-transparent border-0">
                            <a href="Student/studentDisplayPage.php" class="btn btn-sm btn-outline-primary w-100">Manage</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card bg-light border-1 shadow-lg h-100">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="scholarship/scholarshipDisplayPage.php" class="btn btn-sm btn-outline-primary w-100">Manage</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card bg-light border-1 shadow-lg h-100">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="Placement/studentDisplayPage.php" class="btn btn-sm btn-outline-primary w-100">Manage</a>
                        </div>
                    </div>
                </div>
