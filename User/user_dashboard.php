    ...
    <div class="container mt-4 border shadow rounded">
        ...
        <div class="header d-flex justify-content-center align-items-center p-4 bg-light border-bottom">
            <h1 class="dashboard-heading">
                <i class="fas fa-chart-pie"></i>USER DASHBOARD
            </h1>

            <div class="text-end ms-5">
                <p class="mb-1 ms-5"><strong> <?php echo htmlspecialchars($user_name); ?></strong></p>
                <!-- <p class="mb-0">Role: <span class="badge bg-primary"><?php echo htmlspecialchars($user_role); ?></span></p> -->
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card bg-light border-1 shadow-lg h-100">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="../evoting/vote.php" class="btn btn-sm btn-outline-primary w-100">Manage</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card bg-light border-1 shadow-lg h-100">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="../food/meal_schedule.php" class="btn btn-sm btn-outline-primary w-100">Manage</a>
                        </div>
                    </div>
                </div>
