    ...
    <div class="ms-4 me-4 mt-4">
        <div class="row">
            ...
            <div class="col-md-4 text-start ">
                <h1 class="ms-2" style="font-size: 4rem; font-weight: 550; line-height: 1.2;">
                    Building <br><span style="font-weight: 550;"></span>technology for <br><span
                        style="font-weight: 550;">human progress</span>
                </h1>
                <p class="ms-2" style="font-size: 1.3rem; color: #6c757d; margin-top: 15px; line-height: 1.5;">
                    We are a university advancing science <br>
                    and technology education for <br>
                    students from all walks of life.
                </p><br>
                <a href="https://silicon.ac.in/admissions-at-silicon/" class="btn btn-primary ms-2 ">ADMISSIONS 2025-26</a>
            </div>
